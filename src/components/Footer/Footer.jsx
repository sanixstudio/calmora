...
const Footer = () => {
  return (
    <div className="bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]">
      <div className="max-w-[1490px] mx-auto px-10 pt-[120px] pb-[40px]">
        <div className="flex flex-col items-center xl:items-start xl:flex-row xl:justify-between gap-12">
          <div className="w-full xl:w-auto flex flex-col items-center xl:items-start">
            ...
            <div className="relative w-full xs:w-[380px] xl:w-[320px] max-w-[460px] mt-11">
              <input
                type="text"
                placeholder="Email"
                className="rounded-full w-full bg-gray-500 pl-6 pr-[140px] py-4 bg-primary outline-none text-white text-base
          ...
          <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-12 w-full">
            <div className="flex flex-col md:flex-row xs:flex-row gap-12 w-full md:w-auto">
        ...
        <h6 className="text-white text-center lg:text-lg">
          &copy; Calmora - All rights reserved
        </h6>
      </div>
    </div>
  );
